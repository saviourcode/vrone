...
var totalFrames = 907; // the number of images in the sequence of JPEG files (this could be calculated server-side by scanning the frames folder)
...
function resizeAdjustments() { // fit everything to the screen
	...
	if (height_ratio < width_ratio) {
		...
		$('#video').css('height','50%'); // resize image to fill the height of the viewport
